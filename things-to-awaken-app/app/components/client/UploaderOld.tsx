  ...
  return (
    <div className="max-w-md mx-auto mt-10">
      ...
      {isPending ? (
        ...
        <Tabs defaultValue="multiple" className="max-w-[500px] md:w-[500px]">
          ...
          <Form {...uploadForm}>
            ...
            >
              ...
              <TabsContent
                value="multiple"
                className="min-h-[200px] flex flex-col gap-4  mb-4"
              >
                <FormField
                  control={control}
                  name="batch"
                ...
                <div
                  ...
                  // onInput={handleInput}
                  className="bg-white select-text rounded-md min-h-20 whitespace-pre-wrap p-4 shadow-md"
                />
              </TabsContent>
